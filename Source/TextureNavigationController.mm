//
//  TextureNavigationController.mm
//  Texture
//
...
@implementation TextureNavigationController
{
...
{
  as_activity_create_for_scope("Pop multiple from TextureNavigationController");
...
{
  as_activity_create_for_scope("Pop to root of TextureNavigationController");
...
{
  as_activity_create_for_scope("Set view controllers of TextureNavigationController");
...
{
  as_activity_create_for_scope("Push view controller on TextureNavigationController");
...
{
  as_activity_create_for_scope("Pop view controller from TextureNavigationController");
