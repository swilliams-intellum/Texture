 ...
 * depth has changed @see TextureNavigationController.m
 *
 ...
 * visibilityDepth. For example, TextureNavigationController adopts this protocol and manages its childrens visibility
 * depth.
 *
